...
If you don't like this default behavior, you can change it. JSS allows you to supply a [custom class name generator](https://cssinjs.org/jss-api/#generate-your-class-names).
