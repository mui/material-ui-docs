...
Die Klassennamen werden von dem [Klassennamengenerator](/css-in-js/api/#creategenerateclassname-options-class-name-generator) generiert. Nehmen wir den folgenden Stil als Beispiel.
