...
Material Design Lite, while a very well-thought-out Material Design implementation, was primarily maintained by Developer Relations at Google. Aktuell **wird das Projekt nicht länger gepflegt**. Was ist also passiert?
