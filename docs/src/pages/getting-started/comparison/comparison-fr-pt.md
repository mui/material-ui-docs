...
Material Design Lite, while a very well-thought-out Material Design implementation, was primarily maintained by Developer Relations at Google. Hoje, **o projeto não é mais mantido**. Então, o que aconteceu?
