...
> ⚠️ Alterar o tamanho da fonte pode prejudicar a acessibilidade ♿️. Most browsers agreed on the default size of 16px, but the user can change it. Por exemplo, alguém com necessidades especiais na visão poderia ter definido o tamanho padrão da fonte do seu navegador para algo maior.
